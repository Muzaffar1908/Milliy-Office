...
class EmployeeController extends Controller
{
    ...
    {
        $employees = Employee::select('id', 'pos_id', 'dep_id', 'full_name_uz', 'is_active', 'created_at')->orderBy('created_at', 'DESC')->paginate(10);
        $users = User::select('id','user_name', 'created_at')->get();
        $positions = Position::all();
        $departments = Department::all();
        return view('admin.employee.index', compact('employees', 'users', 'positions', 'departments'));
    }
    ...
    public function create_employee()
    {
        $users = User::select('id','user_name', 'created_at')->get();
        $positions = Position::all();
        return view('admin.employee.create_employee', compact('users', 'positions'));
    }
