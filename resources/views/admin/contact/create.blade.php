    ...
    <div class="container">
        <div class="card">
            <div class="card-header border-0 pb-0">
                <h5 class="card-title">Aloqa yaratish</h5>
                        ...
                        <form action="{{route('ct-store')}}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 p-3">
                                    ...
                                    <div>
                                        <input type="text" name="address_uz"  class="form-control" id="address_uz" placeholder="Manzil uz kiriting ..." value="{{old('address_uz')}}" />
                                ...
                                <div class="col-sm-12 p-3">
                                    ...
                                    <div>
                                        <input type="text" name="address_ru"  class="form-control" id="address_ru" placeholder="Manzil ru kiriting ..." value="{{old('address_ru')}}" />
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-sm-12 p-3">
                                    ...
                                    <div>
                                        <input type="text" name="address_en"  class="form-control" id="address_en" placeholder="Manzil en kiriting ..." value="{{old('address_en')}}" />
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-sm-12 p-3">
                                    ...
                                    <div>
                                        <input type="text" name="phone"  class="form-control" id="phone" placeholder="Telefon raqamini kiriting ..." value="{{old('phone')}}" />
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-sm-12 p-3">
                                    ...
                                    <div>
                                        <input type="email" name="email"  class="form-control" id="email" placeholder="Elektron pochtani kiriting ..." value="{{old('email')}}" />
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-sm-12 p-3">
                                    ...
                                    <div>
                                        <input type="datetime-local" name="started_at"  class="form-control" id="started_at" placeholder="Boshlangan vaqtni kiriting ..." value="{{old('started_at')}}" />
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-sm-12 p-3">
                                    ...
                                    <div>
                                        <input type="datetime-local" name="stopped_at"  class="form-control" id="stopped_at" placeholder="Tugagan vaqtni kiriting ..." value="{{old('stopped_at')}}" />
                                        <div class="invalid-feedback">
