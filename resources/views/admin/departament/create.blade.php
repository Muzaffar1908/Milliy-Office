                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="dep_name_uz" class="form-control" id="validationCustom02"  placeholder="Enter is Departament Title uz" required value="{{old('dep_name_uz')}}">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="dep_name_ru" class="form-control" id="validationCustom02"  placeholder="Enter is Departament Title ru" required value="{{old('dep_name_ru')}}">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="dep_name_en" class="form-control" id="validationCustom02"  placeholder="Enter is Departament Title en" required value="{{old('dep_name_en')}}">
                                            <div class="invalid-feedback">
