    ...
    <div class="container">
        <div class="card">
            <div class="card-header border-0 pb-0">
                <h5 class="card-title">Bo'limni yangilash</h5>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                        ...
                                        <div class="">
                                            <select name="user_id" id="single-select" class="form-control">
                                                ...
                                                @foreach($users as $user)
                                                 <option value="{{$user->id}}" @if($user->id == $departament->user_id) selected @endif>{{$user->user_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="">
                                            <input type="text" name="dep_name_uz" class="form-control" id="validationCustom02"  placeholder="Bo'lim sarlavha uz ni kiriting ..." required value="{{$departament->dep_name_uz}}">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="">
                                            <input type="text" name="dep_name_ru" class="form-control" id="validationCustom02"  placeholder="Bo'lim sarlavha ru ni kiriting ..." required value="{{$departament->dep_name_ru}}">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="">
                                            <input type="text" name="dep_name_en" class="form-control" id="validationCustom02"  placeholder="Bo'lim sarlavha en ni kiriting ..." required value="{{$departament->dep_name_en}}">
                                            <div class="invalid-feedback">
