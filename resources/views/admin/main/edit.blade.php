                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="logo_title_uz" class="form-control" id="validationCustom02"  placeholder="Enter is Logo Title uz" required value="{{$main->logo_title_uz}}">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="logo_title_ru" class="form-control" id="validationCustom02"  placeholder="Enter is Logo Title ru" required value="{{$main->logo_title_ru}}">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="logo_title_en" class="form-control" id="validationCustom02"  placeholder="Enter is Logo Title en" required value="{{$main->logo_title_en}}">
                                            <div class="invalid-feedback">
