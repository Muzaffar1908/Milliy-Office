            ...
            <div class="card-body">
                <div class="card p-3">
                    <div class="form-validation">
                        <form action="{{route('p-update', $partners->id)}}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate >
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    {{-- <label for="id"></label> --}}
                                    <input type="hidden" name="id"  class="form-control" id="id" placeholder="Firstname enter" value="{{$partners->id}}" />
                                </div>
                                    ...
                                    <div>
                                        <select name="user_id" id="single-select" class="form-control">
                                            ...
                                            @foreach($users as $user)
                                                <option value="{{$user->id}}" @if($user->id==$partners->user_id) selected @endif >{{$user->user_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 p-3">
                                    ...
                                    <div>
                                        <img src="{{asset('/upload/partner/' .$partners->image.'_thumbnail_550.png')}}" class="p-2" alt="img" with="100px" height="60px">
